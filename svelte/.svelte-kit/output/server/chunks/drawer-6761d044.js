...
import {
  ...
  k as Subheader,
  l as H6,
} from "./pill-logo.svelte_svelte_type_style_lang-e6f75325.js";
...
const IconButton = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if (
      $$props.ariaLabelOn === void 0 &&
      $$bindings.ariaLabelOn &&
      ariaLabelOn !== void 0
    )
      $$bindings.ariaLabelOn(ariaLabelOn);
    if (
      $$props.ariaLabelOff === void 0 &&
      $$bindings.ariaLabelOff &&
      ariaLabelOff !== void 0
    )
    ...
    if (
      $$props.displayFlex === void 0 &&
      $$bindings.displayFlex &&
      displayFlex !== void 0
    )
        ...
        Object_1$1.assign(
          ...
          },
          {
            class: classMap({
              ...
              "mdc-dialog__close":
                context === "dialog:header" && action === "close",
              ...internalClasses,
            }),
          },
          {
  ...
  ${slots.default ? slots.default({}) : ``}${
              touch ? `<div class="${"mdc-icon-button__touch"}"></div>` : ``
            }`;
          },
        }
      )}`;
...
const CommonLabel = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      "use",
      "class",
...
const Button_1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let actionProp;
    let defaultProp;
    let secondaryProp;
  ...
  function getInstance() {
    ...
    return Foundation
      ? new Foundation({
          ...
          removeClass,
          hasClass,
          elementHasClass: (element2, className2) =>
            element2.classList.contains(className2),
...
const Scrim = Scrim$1;
const TopAppBar = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      "use",
      "class",
    ...
    function getInstance() {
      ...
      return new Foundation({
        ...
        notifyNavigationIconClicked: () =>
          dispatch(element, "SMUITopAppBar:nav", void 0, void 0, true),
        getViewportScrollY: () =>
    ...
    if ($$props.color === void 0 && $$bindings.color && color !== void 0)
      $$bindings.color(color);
    if (
      $$props.collapsed === void 0 &&
      $$bindings.collapsed &&
      collapsed !== void 0
    )
      $$bindings.collapsed(collapsed);
    if (
      $$props.prominent === void 0 &&
      $$bindings.prominent &&
      prominent !== void 0
    )
    ...
    if (
      $$props.scrollTarget === void 0 &&
      $$bindings.scrollTarget &&
      scrollTarget !== void 0
    )
      $$bindings.scrollTarget(scrollTarget);
    if (
      $$props.getPropStore === void 0 &&
      $$bindings.getPropStore &&
      getPropStore !== void 0
    )
...
const Section$1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      "use",
      "class",
...
var brandBanner_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
  '.branding.svelte-1535w6g{background-color:var(--mdc-theme-primary, #fff)}.logo.svelte-1535w6g{width:auto;display:block;padding:3px 1em;font-family:"open Sans", san-serif;font-size:1.1em;line-height:2em;font-weight:500}')();
const css$4 = {
...
const Brand_banner = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
var navSubmenu_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
  "@media(max-width: 480px){}")();
const css$3 = {
  code: "@media(max-width: 480px){}",
  map: null,
};
const Nav_submenu = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let nav_menu = [
...
var topbar_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
...
const Topbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="${"hid den"}">${validate_component(
      TopAppBar,
      "TopAppBar"
    ).$$render(
      $$result,
      ...
      {
        default: () => {
          return `${validate_component(Brand_banner, "BrandBanner").$$render(
            $$result,
            {},
            {},
            {}
    ...
    ${validate_component(Row, "Row").$$render(
      ...
      {},
      {
        ...
        ${validate_component(Title, "Title").$$render(
          $$result,
          {},
          {},
          {
    ...
    <div class="${"desktop"}">${validate_component(
            Nav_submenu,
            "NavSubmenu"
          ).$$render($$result, {}, {}, {})}</div>`;
        },
...
var navMenu_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
  ".nav-container.svelte-vy4uvo{position:relative;display:flex;height:auto;overflow:hidden;z-index:0}")();
const css$1 = {
  code: ".nav-container.svelte-vy4uvo{position:relative;display:flex;height:auto;overflow:hidden;z-index:0}",
  map: null,
};
const Nav_menu = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    createEventDispatcher();
    let { active = "Home" } = $$props;
    if ($$props.active === void 0 && $$bindings.active && active !== void 0)
    ...
    return `<div class="${"nav-container svelte-vy4uvo"}">${validate_component(
      List,
      "List"
    ).$$render(
      $$result,
    ...
    <div class="${"hidden"}">${validate_component(
            Separator,
            "Separator"
          ).$$render($$result, {}, {}, {})}
      ${validate_component(Subheader, "Subheader").$$render(
        $$result,
        { component: H6 },
        {},
        {
...
var drawer_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
  ".drawer-container.svelte-ww01vv{position:absolute;display:flex;height:auto;overflow:hidden}.svelte-ww01vv .app-content{flex:auto;overflow:auto;position:relative;flex-grow:1}.main-content.svelte-ww01vv{overflow:auto;height:100%;box-sizing:border-box}")();
const css = {
...
const Drawer_1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { open = false } = $$props;
  ...
  ${validate_component(Drawer, "Drawer").$$render(
    ...
    },
    {
          ...
          {},
          {
            default: () => {
              return `${validate_component(Button_1, "Button").$$render(
                ...
                {
                  default: () => {
                    return `close ${validate_component(
                      IconButton,
                      "IconButton"
                    ).$$render(
                      $$result,
      ...
      ${validate_component(Title$1, "Title").$$render(
        $$result,
        {},
        {},
        {
    ...
    ${validate_component(Content, "Content").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Nav_menu, "NavMenu").$$render(
            $$result,
            {},
            {},
            {}
  ...
  ${validate_component(Scrim, "Scrim").$$render(
    $$result,
    { fixed: false },
    {},
    {}
