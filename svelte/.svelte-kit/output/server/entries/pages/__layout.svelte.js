import { c as create_ssr_component, a as subscribe, s as setContext, o as onDestroy, b as set_store_value, v as validate_component, d as compute_rest_props, g as get_current_component, e as getContext, f as spread, h as escape_attribute_value, i as escape_object, j as add_attribute, k as escape, l as globals, n as compute_slots, p as each, q as createEventDispatcher } from "../../chunks/index-4b7b92f5.js";
import "@material/icon-button";
import "@material/ripple";
import "@material/dom";
import { w as writable, L as LayoutGrid, C as Cell, f as forwardEventsBuilder, c as classMap, a as classAdderBuilder, D as Div, S as Span, e as exclude, p as prefixFilter, b as List, I as Item, T as Text, P as PrimaryText, d as SecondaryText } from "../../chunks/pill-logo.svelte_svelte_type_style_lang-e6f75325.js";
...
<div class="${"footer  svelte-d6boib"}"><div class="${"container"}">${validate_component(LayoutGrid, "LayoutGrid").$$render($$result, {}, {}, {
      default: () => {
      ...
      ${validate_component(Cell, "Cell").$$render($$result, { span: 3, class: "center hidden" }, {}, {
        ...
        ${validate_component(Card, "Card").$$render($$result, { variant: "outlined", padded: true }, {}, {
              default: () => {
            ...
            ${validate_component(Textfield, "Textfield").$$render($$result, {
                  ...
                  helper: () => {
                    return `${validate_component(HelperText, "HelperText").$$render($$result, { validationMsg: true, slot: "helper" }, {}, {
                      default: () => {
              ...
              `;
                  ...
                  trailingIcon: () => {
                    return `${!disabled ? `${validate_component(Icon, "Icon").$$render($$result, { class: "material-icons", role: "button" }, {}, {
                      default: () => {
                        return `send`;
                      }
                    })}` : ``}
            ...
            <pre class="${"status hidden"}">            Focused: ${escape(focused)},
            Dirty: ${escape(dirty)},
