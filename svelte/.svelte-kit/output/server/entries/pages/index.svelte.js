...
import {
  ...
  I as IconButton,
  L as Label,
} from "../../chunks/drawer-6761d044.js";
...
const Blue_swoop = create_ssr_component(
...
const Scroll_actions = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let y;
    let visible;
...
const Background_images = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { src } = $$props;
    let { variant } = $$props;
    let { animation } = $$props;
    ...
    if (
      $$props.animation === void 0 &&
      $$bindings.animation &&
      animation !== void 0
    )
      $$bindings.animation(animation);
    $$result.css.add(css$1);
    return `<div class="${"bg-holder svelte-p28e45"}"><span class="${"background-image svelte-p28e45"}" style="${
      "background: url(" +
      escape(src, true) +
      "); background-position: 50% -21px; background-attachment: " +
      escape(variant, true) +
...
var index_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
  "@media(max-width: 599px){.pill-logo-container.svelte-13ld8k3{max-width:100px}}@media(min-width: 600px) and (max-width: 839px){.pill-logo-container.svelte-13ld8k3{max-width:200px}}@media(min-width: 839px){.pill-logo-container.svelte-13ld8k3{max-width:400px}}")();
const css = {
    ...
    $$rendered = `${validate_component(
      ...
      {},
      {
        default: ({ visible }) => {
          return `${
            visible
              ? `${validate_component(Drawer_1, "NavDrawer").$$render(
                  $$result,
                  { open },
                  {
                    open: ($$value) => {
...
${validate_component(Scroll_actions, "ScrollActions").$$render(
  $$result,
  {},
  {},
  {
...
${validate_component(Scroll_actions, "ScrollActions").$$render(
  ...
  ${
    !visible
      ? `<div>${validate_component(Blue_swoop, "BlueSwoop").$$render(
          $$result,
          {},
          {},
          {}
...
<div class="${"container"}">${validate_component(
      ...
      {},
      {
        default: () => {
          ...
          <div class="${"mobile"}">${validate_component(
                              Button_1,
                              "Button"
                            ).$$render(
                              $$result,
                              ...
                              {
                                default: () => {
                                  return `<div style="display: contents; --width:${"3em"};">${validate_component(
                                    Pill_logo,
                                    "PillLogo"
                                  ).$$render($$result, {}, {}, {})}</div>`;
                                },
  ...
  ${validate_component(LayoutGrid, "LayoutGrid").$$render(
    $$result,
    {},
    {},
    {
              ...
              return `${validate_component(
                ...
                {},
                {
                  default: ({ visible }) => {
                    return `${
                      !visible
                        ? `<div class="${"pill-logo-container desktop svelte-13ld8k3"}"><div style="display: contents; --width:${"20em"};">${validate_component(
                            Pill_logo,
                            "PillLogo"
    ...
    ${validate_component(Cell, "Cell").$$render(
      ...
      {
        default: () => {
          return `<div class="${"demo-cell"}">${validate_component(
            Scroll_actions,
            "ScrollActions"
          ).$$render(
            $$result,
            ...
            {},
            {
              default: ({ visible }) => {
                return `${
                  !visible
                    ? `<div><h1 class="${"bold headline light"}">CRIB</h1>
    ...
    {},
    {
      default: () => {
        return `${validate_component(Card, "Card").$$render(
          ...
          {
            default: () => {
              return `<div style="display: contents; --width:${"8em"};">${validate_component(
                Pill_logo,
                "PillLogo"
              ).$$render($$result, {}, {}, {})}</div>
...
${validate_component(LayoutGrid, "LayoutGrid").$$render(
  ...
  {},
  {
    default: () => {
      return `${validate_component(Cell, "Cell").$$render(
        $$result,
        { span: 12, class: " center" },
        {},
        {
          default: () => {
            return `<span class="${"dark-grey"}"><div style="display: contents; --font-size:${"8em"};">${validate_component(
              IconButton,
              "IconButton"
            ).$$render(
              $$result,
  ...
  ${validate_component(Cell, "Cell").$$render(
    ...
    {
      default: () => {
        return `<span class="${"medium-blue"}"><div style="display: contents; --font-size:${"4em"};">${validate_component(
          IconButton,
          "IconButton"
        ).$$render(
          $$result,
