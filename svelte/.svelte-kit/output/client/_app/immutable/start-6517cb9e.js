...
import { w as le } from "./chunks/index-db7e7858.js";
let Ie = "",
  Ye = "";
function ot(r) {
  (Ie = r.base), (Ye = r.assets || Ie);
}
function ct(r) {
  let e, t, i;
  const l = [r[1] || {}];
  ...
  function f(n) {
    let s = {};
    for (let a = 0; a < l.length; a += 1) s = ae(s, l[a]);
    return { props: s };
  }
  return (
    c && (e = new c(f())),
    {
      ...
      m(n, s) {
        e && q(e, n, s), V(n, t, s), (i = !0);
      },
      p(n, s) {
        const a = s & 2 ? se(l, [ie(n[1] || {})]) : {};
        if (c !== (c = n[0][0])) {
          if (e) {
            Y();
            const d = e;
      ...
      i(n) {
        i || (e && I(e.$$.fragment, n), (i = !0));
      },
      o(n) {
        e && T(e.$$.fragment, n), (i = !1);
      },
      d(n) {
        n && j(t), e && J(e, n);
      },
...
function lt(r) {
  ...
  var c = r[0][0];
  function f(n) {
    let s = { $$slots: { default: [pt] }, $$scope: { ctx: n } };
    for (let a = 0; a < l.length; a += 1) s = ae(s, l[a]);
    return { props: s };
  }
  return (
    c && (e = new c(f(r))),
    {
      ...
      p(n, s) {
        const a = s & 2 ? se(l, [ie(n[1] || {})]) : {};
        if (
          (s & 525 && (a.$$scope = { dirty: s, ctx: n }), c !== (c = n[0][0]))
        ) {
          if (e) {
            Y();
            const d = e;
...
function ut(r) {
  ...
  var c = r[0][1];
  function f(n) {
    let s = { $$slots: { default: [dt] }, $$scope: { ctx: n } };
    for (let a = 0; a < l.length; a += 1) s = ae(s, l[a]);
    return { props: s };
  }
  return (
    c && (e = new c(f(r))),
    {
      ...
      p(n, s) {
        const a = s & 4 ? se(l, [ie(n[2] || {})]) : {};
        if (
          (s & 521 && (a.$$scope = { dirty: s, ctx: n }), c !== (c = n[0][1]))
        ) {
          if (e) {
            Y();
            const d = e;
...
const gt = "modulepreload",
  ...
  fe = [
    () =>
      X(
        () => import("./pages/__layout.svelte-313e985d.js"),
        [
    ...
    () =>
      X(
        () => import("./error.svelte-8c08df4b.js"),
        ["error.svelte-8c08df4b.js", "chunks/index-ec06594a.js"]
      ),
    () =>
      X(
        () => import("./pages/about.svelte-8bae408c.js"),
        [
          "pages/about.svelte-8bae408c.js",
          "chunks/index-ec06594a.js",
          "chunks/drawer-b3e5472e.js",
          "assets/drawer-fc74134e.css",
          "chunks/index-db7e7858.js",
          "chunks/pill-logo.svelte_svelte_type_style_lang-a71f6f3e.js",
          "assets/pill-logo.svelte_svelte_type_style_lang-8be18086.css",
        ]
    ...
    () =>
      X(
        () => import("./pages/contact.svelte-a23eebcf.js"),
        [
          "pages/contact.svelte-a23eebcf.js",
          "chunks/index-ec06594a.js",
          "chunks/drawer-b3e5472e.js",
          "assets/drawer-fc74134e.css",
          "chunks/index-db7e7858.js",
    ...
    () =>
      X(
        () => import("./pages/index.svelte-58642ff6.js"),
        [
          "pages/index.svelte-58642ff6.js",
          "assets/pages/index.svelte-ada0e619.css",
          "chunks/index-ec06594a.js",
          "chunks/drawer-b3e5472e.js",
          "assets/drawer-fc74134e.css",
          "chunks/index-db7e7858.js",
    ...
    () =>
      X(
        () => import("./pages/research.svelte-8483c67a.js"),
        [
          "pages/research.svelte-8483c67a.js",
          "chunks/index-ec06594a.js",
          "chunks/drawer-b3e5472e.js",
          "assets/drawer-fc74134e.css",
          "chunks/index-db7e7858.js",
...
function ze(r) {
  ...
  if (r.error || e) {
    ...
    const i = typeof r.error == "string" ? new Error(r.error) : r.error;
...
function Be(r) {
  ...
  function c(f) {
    ...
    return e.subscribe((s) => {
      (n === void 0 || (t && s !== n)) && f((n = s));
    });
  }
  return { notify: i, set: l, subscribe: c };
}
function kt() {
  const { set: r, subscribe: e } = le(!1),
    t = "1657897057817";
  let i;
  async function l() {
    clearTimeout(i);
    const f = await fetch(`${Ye}/_app/version.json`, {
      headers: { pragma: "no-cache", "cache-control": "no-cache" },
    });
    if (f.ok) {
      const { version: n } = await f.json(),
        s = n !== t;
      return s && (r(!0), clearTimeout(i)), s;
                ...
                return (
                  ...
                  "/" +
                    c
                      ...
                      .map((d, L) => {
                        if (L % 2) {
                          const [, k, H, M] = St.exec(d);
                          return e.push(H), t.push(M), k ? "(.*?)" : "([^/]+?)";
                        }
                        return (
                          a && d.includes(".") && (i = !1),
                          d
...
function Ot(r, e, t) {
  return Object.entries(e).map(([l, [c, f, n]]) => {
    const { pattern: s, names: a, types: d } = Ut(l);
    return {
      id: l,
      exec: (L) => {
        const k = s.exec(L);
        if (k) return At(k, a, d, t);
      },
      a: c.map((L) => r[L]),
      b: f.map((L) => r[L]),
      has_shadow: !!n,
...
let ne = {};
try {
  ne = JSON.parse(sessionStorage[Ge]);
} catch {}
function be(r) {
  ne[r] = ve();
}
function xt({ target: r, session: e, base: t, trailing_slash: i }) {
  var Ne;
  const l = new Map(),
    c = [],
    f = {
  ...
  f.session.subscribe(async (o) => {
    (ke = o), Re && ((H += 1), he(new URL(location.href), [], !0));
  }),
    (Re = !0);
  let F = !0,
    C = (Ne = history.state) == null ? void 0 : Ne[B];
  C ||
    ((C = Date.now()),
    history.replaceState({ ...history.state, [B]: C }, "", location.href));
  const ue = ne[C];
  ...
  async function Ue(o) {
    ...
    return (n.promise = Oe(p, !1)), (n.id = p.id), n.promise;
  }
  async function he(o, p, w, u, h) {
    var R, S, O;
    const b = Pe(o),
      v = (Le = {});
    let _ = b && (await Oe(b, w));
    if (
      (!_ &&
    ...
    (F = (m == null ? void 0 : m.module.router) !== !1), h && h(), (k = !1);
  }
  function Ae(o) {
    a = o.state;
    ...
    if (
      ...
      s.after_navigate.forEach((u) => u(w));
    }
    d = !0;
  }
  async function _e({
    ...
    if (!a.url || o.href !== a.url.href || a.error !== b || a.stuff !== w) {
      ...
      const g = (P, E) => {
        Object.defineProperty(R.props.page, P, {
          get: () => {
            throw new Error(`$page.${P} has been replaced by $page.url.${E}`);
          },
        });
      };
    ...
    if ($) {
      ...
      const E = () => {
        ...
        A = setTimeout(E, $.maxage * 1e3),
        N = f.session.subscribe(() => {
          P && E();
        });
      (P = !0), l.set(g, R);
    }
    ...
    if (w.load) {
      const y = {
        ...
        async fetch(g, P) {
          ...
          const A = new URL(E, u).href;
          return R(A), d ? $e(A, P) : Lt(E, P);
        },
  ...
  async function Oe({ id: o, url: p, params: w, route: u }, h) {
    var U, g, P;
    ...
    const { a: b, b: v, has_shadow: _ } = u,
      m = a.url && {
        ...
        params: Object.keys(w).filter((E) => a.params[E] !== w[E]),
    ...
    e: for (let E = 0; E < b.length; E += 1) {
      ...
      try {
        ...
        if (
          ...
          N !== D.module ||
          (m.url && D.uses.url) ||
          m.params.some((W) => D.uses.params.has(W)) ||
          (m.session && D.uses.session) ||
          Array.from(D.uses.dependencies).some((W) => c.some((ce) => ce(W))) ||
          (O && D.uses.stuff)
        ) {
          let W = {};
          const ce = _ && E === b.length - 1;
          if (ce) {
            const te = await $e(
            ...
            if (te.ok) {
              const xe = te.headers.get("x-sveltekit-location");
              if (xe) return { redirect: xe, props: {}, state: a };
  ...
  async function me({
    ...
    if ((s.before_navigate.forEach(($) => $(R)), m)) {
      v();
      return;
    }
    ...
    be(C),
      ...
      await he(O, u, !1, { scroll: p, keepfocus: w, details: h }, () => {
        const $ = { from: _, to: O };
        s.after_navigate.forEach((y) => y($)), f.navigating.set(null);
      });
  }
  function ee(o) {
  ...
  return {
    ...
    _start_router: () => {
      (history.scrollRestoration = "manual"),
        addEventListener("beforeunload", (u) => {
          ...
          s.before_navigate.forEach((v) => v(b)),
            h
        ...
        addEventListener("visibilitychange", () => {
          if (document.visibilityState === "hidden") {
            be(C);
            try {
              sessionStorage[Ge] = JSON.stringify(ne);
            } catch {}
          }
        });
      const o = (u) => {
      ...
      addEventListener("touchstart", o),
        ...
        addEventListener("click", (u) => {
          ...
          if (R !== void 0 && m === location.href.split("#")[0]) {
            (de = !0), be(C), f.page.set({ ...pe, url: v }), f.page.notify();
            return;
          }
          me({
            url: v,
    ...
    _hydrate: async ({
      ...
      try {
        ...
        if (p) throw S;
        m = await Q({ status: 500, error: Ve(S), url: b, routeId: h });
      }
      m.redirect && (await ee(new URL(m.redirect, location.href))), Ae(m);
    },
  };
}
async function Ct({
